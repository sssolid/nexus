...
urlpatterns = [
    ...
    # Legacy registration pending (kept for backwards compatibility)
    path('registration-pending/', views.registration_pending_view, name='registration_pending'),

    # Profile
    path('profile/', views.profile_view, name='profile'),

    # Approval management (for sales reps)
    path('approvals/', views_verification.pending_approvals_list_view, name='pending_approvals_list'),
    path('approvals/<int:user_id>/approve/', views_verification.approve_registration_view, name='approve_user'),
    path('approvals/<int:user_id>/reject/', views_verification.reject_registration_view, name='reject_user'),
]