...
class ChangeDetails(AutocareAPIMetadata, models.Model):
    ...
    change = models.ForeignKey('autocare_vcdb.Changes', db_column='ChangeID', db_index=True, on_delete=models.DO_NOTHING)
    change_attribute_state = models.ForeignKey('autocare_vcdb.ChangeAttributeStates', db_column='ChangeAttributeStateID', db_index=True, on_delete=models.DO_NOTHING)
    table_name = models.ForeignKey('autocare_vcdb.ChangeTableNames', db_column='TableNameID', db_index=True, on_delete=models.DO_NOTHING)
    ...
    class Meta:
        ...
        managed = True
        db_table = '"autocare_vcdb"."ChangeDetails"'
