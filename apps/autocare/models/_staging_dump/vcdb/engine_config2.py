...
class EngineConfig2(AutocareAPIMetadata, models.Model):
    ...
    engine_vinid = models.ForeignKey('autocare_vcdb.EngineVIN', db_column='EngineVINID', db_index=True, on_delete=models.DO_NOTHING)
    valves = models.ForeignKey('autocare_vcdb.Valves', db_column='ValvesID', db_index=True, on_delete=models.DO_NOTHING)
    engine_base = models.ForeignKey('autocare_vcdb.EngineBase2', db_column='EngineBaseID', db_index=True, on_delete=models.DO_NOTHING)
    ...
    engine_mfr = models.ForeignKey('autocare_vcdb.Mfr', db_column='EngineMfrID', db_index=True, on_delete=models.DO_NOTHING)
    ...
    class Meta:
        ...
        managed = True
        db_table = '"autocare_vcdb"."EngineConfig2"'
        verbose_name = 'EngineConfig2'
        verbose_name_plural = 'EngineConfig2s'
        indexes = [
