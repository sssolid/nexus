...
class SteeringConfig(AutocareAPIMetadata, models.Model):
    ...
    steering_type = models.ForeignKey('SteeringType', db_column='SteeringTypeID', db_index=True, on_delete=models.DO_NOTHING)
    steering_system = models.ForeignKey('SteeringSystem', db_column='SteeringSystemID', db_index=True, on_delete=models.DO_NOTHING)
