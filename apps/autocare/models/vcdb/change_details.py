...
class ChangeDetails(AutocareAPIMetadata, models.Model):
    ...
    changes = models.ForeignKey('Changes', db_column='ChangeID', db_index=True, on_delete=models.DO_NOTHING)
    change_attribute_states = models.ForeignKey('ChangeAttributeStates', db_column='ChangeAttributeStateID', db_index=True, on_delete=models.DO_NOTHING)
    change_table_names = models.ForeignKey('ChangeTableNames', db_column='TableNameID', db_index=True, on_delete=models.DO_NOTHING)
