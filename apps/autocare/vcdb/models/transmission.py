...
class Transmission(AutocareAPIMetadata, models.Model):
    ...
    elec_controlled = models.ForeignKey('autocare_vcdb.ElecControlled', db_column='TransmissionElecControlledID', db_index=True, on_delete=models.DO_NOTHING)
    mfr = models.ForeignKey('autocare_vcdb.Mfr', db_column='TransmissionMfrID', db_index=True, on_delete=models.DO_NOTHING)
