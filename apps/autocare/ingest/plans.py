...
VCDB_BASELINE_PLAN: List[EndpointSpec] = [
    ...
    EndpointSpec("vcdb", "Mfr", "v1", "Mfr"),
    EndpointSpec("vcdb", "MfrBodyCode", "v1", "MfrBodyCode"),
    ...
    EndpointSpec("vcdb", "TransmissionMfrCode", "v1", "TransmissionMfrCode"),
    ...
    EndpointSpec("vcdb", "VehicleToMfrBodyCode", "v1", "VehicleToMfrBodyCode"),
]


PCDB_PLAN: List[EndpointSpec] = [
    EndpointSpec("pcdb", "ACESCodedValues", "v1", "ACESCodedValues"),
    EndpointSpec("pcdb", "Alias", "v1", "Alias"),
    EndpointSpec("pcdb", "Categories", "v1", "Categories"),
    EndpointSpec("pcdb", "PartCategory", "v1", "PartCategory"),
    EndpointSpec("pcdb", "PartPosition", "v1", "PartPosition"),
    EndpointSpec("pcdb", "Parts", "v1", "Parts"),
    EndpointSpec("pcdb", "PartsDescription", "v1", "PartsDescription"),
    EndpointSpec("pcdb", "PartsRelationship", "v1", "PartsRelationship"),
    EndpointSpec("pcdb", "PartsSupersession", "v1", "PartsSupersession"),
    EndpointSpec("pcdb", "PartsToAlias", "v1", "PartsToAlias"),
    EndpointSpec("pcdb", "PartsToUse", "v1", "PartsToUse"),
    EndpointSpec("pcdb", "PIESCode", "v1", "PIESCode"),
    EndpointSpec("pcdb", "PIESEXPICode", "v1", "PIESEXPICode"),
    EndpointSpec("pcdb", "PIESEXPIGroup", "v1", "PIESEXPIGroup"),
    EndpointSpec("pcdb", "PIESField", "v1", "PIESField"),
    EndpointSpec("pcdb", "PIESReferenceFieldCode", "v1", "PIESReferenceFieldCode"),
    EndpointSpec("pcdb", "PIESSegment", "v1", "PIESSegment"),
    EndpointSpec("pcdb", "Positions", "v1", "Positions"),
    EndpointSpec("pcdb", "Subcategories", "v1", "Subcategories"),
    EndpointSpec("pcdb", "Use", "v1", "Use"),
]


PADB_PLAN: List[EndpointSpec] = [
    EndpointSpec("padb", "MeasurementGroup", "v4", "MeasurementGroup"),
    EndpointSpec("padb", "MetaData", "v4", "MetaData"),
    EndpointSpec("padb", "MetaUOMCodeAssignment", "v4", "MetaUOMCodeAssignment"),
    EndpointSpec("padb", "MetaUOMCodes", "v4", "MetaUOMCodes"),
    EndpointSpec("padb", "PartAttributeAssignment", "v4", "PartAttributeAssignment"),
    EndpointSpec("padb", "PartAttributes", "v4", "PartAttributes"),
    EndpointSpec("padb", "PartAttributeStyle", "v4", "PartAttributeStyle"),
    EndpointSpec("padb", "PartTypeStyle", "v4", "PartTypeStyle"),
    EndpointSpec("padb", "Style", "v4", "Style"),
    EndpointSpec("padb", "ValidValueAssignment", "v4", "ValidValueAssignment"),
    EndpointSpec("padb", "ValidValues", "v4", "ValidValues"),
]
